...
| Modelo de datos (ER canónico) | `docs/00-overview/02-modelo-datos-global.md` |
| Convenciones de código | `docs/00-overview/04-convenciones.md` |
| **Notion (reglas duras)** | `agente/reglas-notion.md` → detalle en `docs/transversal/integracion-notion.md` |
| Correo (Gmail+IMAP) | `docs/transversal/integracion-correo.md` |
| Calendar / eventos | `docs/transversal/integracion-calendar.md` |
| IA runtime (headless) | `docs/modules/M6-asistente-ia.md` + `agente/stack.md` |
