...
- **TRANSVERSAL** (`transversal/`) — integraciones (Notion, correo, Calendar), infra/DevOps, diseño, calidad.
...
docs/
  ...
  transversal/{integracion-notion,integracion-correo,integracion-calendar,infra-devops,sistema-de-diseno,calidad-y-pruebas}.md
